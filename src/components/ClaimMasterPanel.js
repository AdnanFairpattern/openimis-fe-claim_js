    ...
    return (
      ...
      .MuiAutocomplete-hasPopupIcon .MuiAutocomplete-inputRoot, .MuiAutocomplete-hasClearIcon .MuiAutocomplete-inputRoot {
        ...
        <ControlledField
          ...
          id="Claim.insuree"
          field={
            <Grid item xs={6} className={classes.item} id="problem" >
              <PublishedComponent
        ...
        <ControlledField
          ...
          id="Claim.visitType"
          field={
            <Grid item xs={forFeedback || forReview ? 12 :6 } className={classes.item}>
              <PublishedComponent
        ...
        <ControlledField
          ...
          id="Claim.guarantee"
          field={
            <Grid item xs={!forReview && edited.status >= 4 && !forFeedback ? 12 : 6} className={classes.item}>
              <TextInput
                module="claim"
                label="guaranteeId"
        ...
        {!forFeedback && (
          <ControlledField
            ...
            id="Claim.claimed"
            field={
              <Grid item xs={forReview || edited.status >= 4 ? 12 : 6} className={classes.item}>
        ...
        {!forFeedback && (
          <Fragment >
            <ControlledField
              ...
              field={
                <Grid item xs={this.showAdjustmentAtEnter ? 12 : 6} className={classes.item}>
                  <TextInput
                    module="claim"
                    label="explanation"
